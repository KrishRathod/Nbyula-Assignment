...
<div class="col-md-10">
<a href="mailto:studenta@gmail.com" style="color:#000000">studentabc@yahoo.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		<img src="image/bg.jpg" width=100 height=100 alt="Studenta" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Student</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7452963215</h4>
    <h4 style="font-family:'typo' ">studenta@gmail.com</h4>
